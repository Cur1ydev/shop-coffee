                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="name" type="text"
                                                       placeholder="Tên danh mục" value="{{$findcategory->name}}">
                                            </div>
                                            @error('name')
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="js-example-basic-single w-100" name="status">
                                                    ...
                                                    <option value="1" {{$findcategory->status==1?'selected':''}}>Sẵn Sàng
                                                    </option>
                                                    <option value="0" {{$findcategory->status==0?'selected':''}}>Ngừng kinh
                                                        doanh
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea name="description" id="" cols="50"
                                                          rows="10">{{$findcategory->description}}</textarea>
                                            </div>
                                            @error('description')
                                            <h5 style="color: red" align="center">{{$message}}</h5>
                                            @enderror
