                        ...
                        <div class="contact__wrapper">
                            <div class="row mt-none-30">
                                <div class="col-lg-4 col-md-6 mt-30">
                                    <div class="contact-info d-flex align-items-center justify-content-center">
                                        <div class="icon d-flex align-items-center justify-content-center">
                                            <img src="{{asset('client/assets/images/icons/ci-1.png')}}" alt="">
                                        </div>
                                        <div class="content">
                                ...
                                <div class="col-lg-4 col-md-6 mt-30">
                                    <div class="contact-info d-flex align-items-center justify-content-center">
                                        <div class="icon d-flex align-items-center justify-content-center">
                                            <img src="{{asset('client/assets/images/icons/ci-2.png')}}" alt="">
                                        </div>
                                        <div class="content">
                                ...
                                <div class="col-lg-4 col-md-6 mt-30">
                                    <div class="contact-info d-flex align-items-center justify-content-center">
                                        <div class="icon d-flex align-items-center justify-content-center">
                                            <img src="{{asset('client/assets/images/icons/ci-3.png')}}" alt="">
                                        </div>
                                        <div class="content">
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="contact__form mt-20">
                                        <form action="https://xpressrow.com/html/cafena/cafena/index.html" method="get">
                                            <div class="row">
