    ...
    <main>
            ...
            <div class="container">
                ...
                <div class="row mt-none-30">
                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30 text-center">
                        <div class="wcu__item">
                            <div class="icon">
                                <img src="{{asset('client/assets/images/icons/wcu-1.png')}}" alt="">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30 text-center">
                        <div class="wcu__item">
                            <div class="icon">
                                <img src="{{asset('client/assets/images/icons/wcu-2.png')}}" alt="">
                            </div>
                            <div class="content">
        ...
        <div class="best-coffe__area position-relative">
            <div class="best-coffe__bg">
                <img src="{{asset('client/assets/images/bg/best-coffe-1.jpg')}}" alt="">
            </div>
            <div class="container">
            ...
            <div class="container">
                ...
                <div class="row mt-none-30">
                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                        <div class="team__box">
                            <div class="thumb mb-30">
                                <img src="{{asset('client/assets/images/team/team-1.jpg')}}" alt="">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                        <div class="team__box">
                            <div class="thumb mb-30">
                                <img src="{{asset('client/assets/images/team/team-2.jpg')}}" alt="">
                                <div class="social-links">
