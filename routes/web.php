...
Route::get('/', [ClientHomeController::class, 'index'])
    ->name('client.home');
Route::get('/menu', [ClientMenuController::class, 'Menu'])
    ->name('client.menu');
Route::get('/product/{slug}', [ClientProductDetailController::class, 'ProductDetail'])
    ->name('client.product');
Route::get('/cart', [ClientCartController::class, 'index'])
    ->name('client.cart');
Route::post('/cart', [ClientCartController::class, 'handleAddtocart'])
    ->name('client.addtocart');
Route::get('/selectAddress', [ClientCartController::class, 'selectAddress'])
    ->name('client.address');
Route::get('/increaseQuantity', [ClientCartController::class, 'increaseQuantity'])
    ->name('client.increaseQuantity');
Route::get('/deleteItemCart-{id}', [ClientCartController::class, 'deleteItemCart'])
    ->name('client.deleteItemCart');
Route::get('/delSs', [ClientCartController::class, 'DeleteAllSession'])
    ->name('client.deleteSS');
Route::get('/shop', [ClientShopController::class, 'index'])
    ->name('client.shop');
Route::post('payment', [PaymentController::class, 'handleApiVnpay'])
    ->name('client.payment');
...
Route::prefix('/adminn')->middleware('login')->name('admin.')->group(function () {
    ...
    Route::prefix('/product')->name('product.')->group(function () {
        ...
        Route::get('/add', [AdminProductController::class, 'Add'])
            ->name('add');
        Route::post('/add', [AdminProductController::class, 'AddPost'])
            ->name('addPost');
        Route::get('/update-{id}', [AdminProductController::class, 'Update'])
            ->name('update');
        Route::post('/update-{id}', [AdminProductController::class, 'UpdatePost'])
            ->name('updatePost');
        Route::get('/delete-{id}', [AdminProductController::class, 'Delete'])
            ->name('delete');
    });
    Route::prefix('/attribute')->name('attribute.')->group(function () {
        Route::get('/list', [AdminAttributeController::class, 'List'])
            ->name('list');
        Route::get('/add', [AdminAttributeController::class, 'Add'])
            ->name('add');
        Route::post('/add', [AdminAttributeController::class, 'AddPost'])
            ->name('addPost');
        Route::get('/update-{id}', [AdminAttributeController::class, 'Update'])
            ->name('update');
        Route::post('/update-{id}', [AdminAttributeController::class, 'UpdatePost'])
            ->name('updatePost');
        Route::get('/delete-{id}', [AdminAttributeController::class, 'Delete'])
            ->name('delete');
    });
    Route::prefix('/category')->name('category.')->group(function () {
        ...
        Route::get('/add', [AdminCategoryController::class, 'Add'])
            ->name('add');
        Route::post('/add', [AdminCategoryController::class, 'AddPost'])
            ->name('addPost');
        Route::get('/update-{id}', [AdminCategoryController::class, 'Update'])
            ->name('update');
        Route::post('/update-{id}', [AdminCategoryController::class, 'UpdatePost'])
            ->name('updatePost');
    ...
    Route::prefix('/product-attribute')->name('productattribute.')->group(function () {
        Route::get('/list', [AdminProductAttributeController::class, 'List'])
            ->name('list');
        Route::get('/add', [AdminProductAttributeController::class, 'Add'])
            ->name('add');
        Route::post('/add', [AdminProductAttributeController::class, 'AddPost'])
            ->name('addPost');
        Route::get('/update-{product_id}-{attribute_id}', [AdminProductAttributeController::class, 'Update'])
            ->name('update');
        Route::post('/update-{product_id}-{attribute_id}', [AdminProductAttributeController::class, 'UpdatePost'])
            ->name('updatePost');
        Route::get('/delete-{product_id}-{attribute_id}', [AdminProductAttributeController::class, 'Delete'])
            ->name('delete');
    });
    Route::prefix('/coupon')->name('coupon.')->group(function () {
        Route::get('/list', [AdminCouponController::class, 'List'])
            ->name('list');
        Route::get('/add', [AdminCouponController::class, 'Add'])
            ->name('add');
        Route::post('/add', [AdminCouponController::class, 'AddPost'])
            ->name('addPost');
        Route::get('/update-{id}', [AdminCouponController::class, 'Update'])
            ->name('update');
        Route::post('/update-{id}', [AdminCouponController::class, 'UpdatePost'])
            ->name('updatePost');
    ...
    Route::prefix('/province')->name('province.')->group(function () {
        Route::get('/list', [AdminProvinceController::class, 'List'])
            ->name('list');
        Route::get('/add', [AdminProvinceController::class, 'Add'])
            ->name('add');
        Route::post('/add', [AdminProvinceController::class, 'AddPost'])
            ->name('addPost');
        Route::get('/update-{id}', [AdminProvinceController::class, 'Update'])
            ->name('update');
        Route::post('/update-{id}', [AdminProvinceController::class, 'UpdatePost'])
            ->name('updatePost');
        Route::get('/delete-{id}', [AdminProvinceController::class, 'Delete'])
            ->name('delete');
    });
    Route::prefix('/address')->name('address.')->group(function () {
        Route::get('/list', [AdminAddressController::class, 'List'])
            ->name('list');
        Route::get('/add', [AdminAddressController::class, 'Add'])
            ->name('add');
        Route::post('/add', [AdminAddressController::class, 'AddPost'])
            ->name('addPost');
        Route::get('/update-{id}', [AdminAddressController::class, 'Update'])
            ->name('update');
        Route::post('/update-{id}', [AdminAddressController::class, 'UpdatePost'])
            ->name('updatePost');
        Route::get('/delete-{id}', [AdminAddressController::class, 'Delete'])
            ->name('delete');
    });
    Route::prefix('/order-item')->name('orderitem.')->group(function () {
        Route::get('/list', [AdminOrderItemController::class, 'List'])
            ->name('list');
        Route::get('/delete-{id}', [AdminOrderItemController::class, 'Delete'])
            ->name('delete');
    });
